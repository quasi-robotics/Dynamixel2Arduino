...
const ModelControlTableInfo_t pro_r_control_table[] PROGMEM = {
  ...
  {ControlTableItem::LED_RED_L,                 563, 1},
  {ControlTableItem::LED_GREEN_L,               564, 1},
  {ControlTableItem::LED_BLUE_L,                565, 1},
...
const ModelControlTableInfo_t pro_ra_pro_plus_control_table[] PROGMEM = {
 ...
 || ENABLE_ACTUATOR_PRO_PLUS)
  ...
  {ControlTableItem::LED_RED_L,                 513, 1},
  {ControlTableItem::LED_GREEN_L,               514, 1},
  {ControlTableItem::LED_BLUE_L,                515, 1},
